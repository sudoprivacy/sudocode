...
A 0.x minor bump: this release changes model-facing behavior (system prompt, tool output limits) and on-screen rendering, not just fixes. Pinned 0.1.x installs are unaffected until you upgrade.
